...
const REACH_DEPTH = 8; // depths for technique rating to climb floor → top
const FLOOR_PCT = 0.45; // rating floor — starts at ~median technique (p45 ≈ 151 on real fixture)
