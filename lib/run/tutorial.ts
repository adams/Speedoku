...
// Canonical solved grid with col-8 of rows 0–3 removed. Each empty cell is the
// only missing value in its row → a forced single. Fail-proof and unique.
export const TUTORIAL_GRID: Grid = [
